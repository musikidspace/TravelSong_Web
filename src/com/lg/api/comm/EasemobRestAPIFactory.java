...
import com.lg.api.impl.HttpClientRestAPIInvoker;
import com.lg.api.impl.JerseyRestAPIInvoker;

public class EasemobRestAPIFactory {
	
	public static final String TOKEN_CLASS = "EasemobAuthToken";
	
	public static final String USER_CLASS = "UserAPIImpl";
	...
	private static final String BASE_PACKAGE = "com.lg.api.impl";
